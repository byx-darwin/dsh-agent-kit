...
import { CHANNEL_CLIS, installArgs, installCommand, type ChannelCliId } from '../common/clis.js'
import { buildSendArgs } from '../dingtalk/args.js'
import { buildFeishuArgs } from '../feishu/args.js'
import { identityAvailable } from '../feishu/output.js'
import { NOTIFY_CHANNELS, type NotifyChannel } from '../notify/config.js'
